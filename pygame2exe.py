# As per http://www.pygame.org/wiki/Pygame2exe
# 
...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "PyTris.pyw"
 
        #Name of program
        self.project_name = "PyTris"
 
        #Project url
        self.project_url = "http://maciakl.github.com/Pytris"
        ...
        #Auhor of program
        self.author_name = "Lukasz Grzegorz Maciak"
        self.author_email = "luke@maciak.net"
        self.copyright = "Copyright (c) 2010 Lukasz Grzegorz Maciak."
 
        #Description
        self.project_description = "Simple Tetris Clone"
